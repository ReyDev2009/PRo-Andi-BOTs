...
tl_admin_users = ['Andi9919','Alucard931121','KOD_16','Orisha91','Wachu985'] #Poner aqui los user con acceso permanente
godlist = ['Andi9919','Alucard931121','KOD_16','Orisha91','Wachu985'] #Poner aqui los admin 
